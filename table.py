...
class InteractiveTable(RelativeLayout):
    def __init__(self, **kwargs):
        ...
        self.modify_box.add_widget(TextInput(hint_text='Start Time', multiline=False, size_hint_y=0.4, pos_hint={'center_y':0.5}))
        self.modify_box.add_widget(TextInput(hint_text='End Time', multiline=False, size_hint_y=0.4, pos_hint={'center_y':0.5}))
        self.modify_box.add_widget(TextInput(hint_text='Text', multiline=False, size_hint_y=0.4, pos_hint={'center_y':0.5}))
